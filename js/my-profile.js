$(document).ready(function() {
        ...
        $(function() {
            ...
            $.get(url, function(data, status) {
                ...
                $('.account').attr('href', "edit.html?id=" + data.Id);
                $(".dashboard").attr('href', "ui.html?id=" + data.Id);
                $(".my-profile").attr('href', "view.html?id=" + data.Id);
                ...
                $(".cancel").click(function() {
                    window.location.href = "ui.html?id=" + data.Id;
                });
                $("#save").click(function() {
                    var newuser = {};
                    newuser.Id = data.Id;
